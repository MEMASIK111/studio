...
export const mockDishes: Dish[] = [
  ...
  },
  {
    ...
    description: 'Необычный ролл по мотивам знаменитого салата, с курицей и соусом Цезарь.',
    ingredients: ['Рис', 'Нори', 'Куриное филе', 'Салат Айсберг', 'Сыр Пармезан', 'Соус Цезарь'],
    price: 410,
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: '/roll-caesar with krivetka.png',
    dataAiHint: 'sushi caesar chicken',
    popular: false,
    new: true,
    rating: 4.7,
    reviews: 60,
  ...
  },
  {
    ...
    description: 'Необычный ролл по мотивам знаменитого салата, с тигровой креветкой и соусом Цезарь.',
