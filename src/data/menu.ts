...
export const mockDishes: Dish[] = [
  ...
  // New
  {
    ...
    imageUrl: '/Унаги Темпура Ролл.png',
  ...
  {
    id: '18',
    name: 'Ролл "Зеленый Дракон"',
    description: 'Элегантный ролл с угрем, авокадо и огурцом, покрытый соусом унаги.',
    ingredients: ['Рис', 'Нори', 'Угорь', 'Авокадо', 'Огурец', 'Сливочный сыр', 'Соус унаги', 'Кунжут'],
    price: 490,
    category: 'rolls',
    subCategory: 'cold-rolls',
    imageUrl: '/Зеленый Дракон.png',
    dataAiHint: 'sushi eel',
    popular: false, 
    new: false, 
    rating: 4.8, 
    reviews: 95,
  ...
  },
  {
    id: '20',
    name: 'Ролл "Авокадо"',
    description: 'Легкий и свежий вегетарианский ролл с нежным авокадо.',
    ingredients: ['Рис', 'Нори', 'Авокадо', 'Кунжут'],
    price: 250,
    category: 'rolls',
    subCategory: 'cold-rolls',
    imageUrl: '/Авокадо.png',
    dataAiHint: 'sushi avocado',
    popular: false, 
    new: false, 
    rating: 4.5, 
    reviews: 60,
  ...
  // == NEW HOT ROLLS ==
  {
    ...
    description: 'Хрустящий горячий ролл с тигровой креветкой в темпуре, авокадо и нежным соусом.',
    ingredients: ['Рис', 'Нори', 'Креветка в темпуре', 'Авокадо', 'Икра тобико', 'Соус спайси'],
    price: 430,
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: '/Темпура ролл с креветкой.png',
    dataAiHint: 'sushi shrimp tempura',
    popular: false, 
    new: false, 
    rating: 4.7, 
    reviews: 88,
  ...
  {
    id: '22',
    name: 'Запеченный ролл "Вулкан"',
    description: 'Горячий запеченный ролл с крабовым мясом, покрытый шапочкой из пикантного соуса.',
    ingredients: ['Рис', 'Нори', 'Крабовое мясо (имитация)', 'Огурец', 'Сырный соус', 'Соус унаги', 'Кунжут'],
    price: 410,
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: '/Запеченный ролл Вулкан.png',
    dataAiHint: 'sushi baked crab',
    popular: true, 
    new: false, 
    rating: 4.8, 
    reviews: 115,
  },
  {
    ...
    description: 'Нежный запеченный ролл с лососем, сливочным сыром и японским майонезом.',
    ingredients: ['Рис', 'Нори', 'Лосось', 'Сливочный сыр', 'Японский майонез', 'Соус унаги'],
    price: 450,
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: '/Запеченный ролл с лососем.png',
  ...
  },
  {
    ...
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: '/Запеченный ролл Якитори.png',
    dataAiHint: 'sushi baked salmon',
    popular: false,
    new: true,
    rating: 4.7,
  ...
  },
  {
    ...
    category: 'rolls',
    subCategory: 'cold-rolls',
    imageUrl: '/Калифорния с Креветкой.png',
