...
export const mockDishes: Dish[] = [
  ...
  },
  {
    ...
    description: 'Соус Цезарь, пармезан, лист салата, креветки, помидоры.',
    ingredients: ['Рис', 'Нори', 'Соус Цезарь', 'Сыр Пармезан', 'Лист салата', 'Креветки', 'Помидоры'],
    price: 390,
    category: 'rolls',
  ...
  },
  {
    ...
    description: 'Соус Цезарь, пармезан, лист салата, курица, помидоры.',
    ingredients: ['Рис', 'Нори', 'Соус Цезарь', 'Сыр Пармезан', 'Лист салата', 'Курица', 'Помидоры'],
    price: 350,
    category: 'rolls',
    subCategory: 'cold-rolls',
