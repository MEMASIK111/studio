...
export const mockDishes: Dish[] = [
  ...
  },
  {
    ...
    category: 'rolls',
    subCategory: 'cold-rolls',
    imageUrl: '/roll-rolls-of-oia.png',
  ...
  },
  {
    id: '30',
    name: 'Ролл Йоко Мако',
    description: 'Нежный ролл со сливочным сыром, огурцом и шапкой из икры масаго.',
    ingredients: ['Рис', 'Нори', 'Сливочный сыр', 'Огурец', 'Икра Масаго'],
    price: 360,
    category: 'rolls',
    subCategory: 'cold-rolls',
    imageUrl: '/roll-Yoko-mako.png',
    dataAiHint: 'sushi cream cheese',
    popular: false,
    new: false,
    rating: 4.4,
    reviews: 70,
