...
export const mockDishes: Dish[] = [
  ...
  // Rolls
  {
    ...
    dataAiHint: 'sushi salmon avocado',
    popular: false,
    new: false,
    rating: 4.5,
    reviews: 55,
  ...
  },
  {
    ...
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: '/roll-Caesar s kuricoi.png',
  ...
  },
  {
    ...
    description: 'Роскошная пицца с креветками, мидиями, кальмарами и нежным сливочным соусом.',
    ingredients: ['Тесто', 'Сливочный соус', 'Сыр моцарелла', 'Креветки', 'Мидии', 'Кальмары', 'Помидоры черри', 'Петрушка'],
    prices: { '30 см': 550, '40 см': 850 },
    category: 'pizza',
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'seafood pizza',
    popular: false,
    new: true,
    rating: 4.8,
    reviews: 15,
  },
  {
    id: '34',
    name: 'Ролл "Вулкан"',
    description: 'Запеченный ролл с угрем, авокадо и сливочным сыром, политый пикантным соусом "Вулкан".',
    ingredients: ['Рис', 'Нори', 'Угорь', 'Авокадо', 'Сливочный сыр', 'Соус "Вулкан"', 'Кунжут'],
    price: 480,
    category: 'rolls',
    subCategory: 'hot-rolls',
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'sushi volcano',
    popular: false,
    new: true,
    rating: 4.9,
    reviews: 22,
  },
  {
    ...
    description: 'Классический греческий салат со свежими овощами, сыром фета, маслинами и оливковой заправкой.',
    ingredients: ['Помидоры', 'Огурцы', 'Болгарский перец', 'Красный лук', 'Сыр фета', 'Маслины', 'Оливковое масло', 'Орегано'],
    price: 320,
    category: 'salads',
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description: 'Итальянская паста со сливочным соусом, беконом, пармезаном и яичным желтком.',
    ingredients: ['Спагетти', 'Бекон', 'Сливки', 'Яичный желток', 'Сыр пармезан', 'Черный перец'],
    price: 450,
  ...
  },
  {
    ...
    description: 'Освежающий лимонад с натуральным малиновым пюре и свежей мятой.',
    ingredients: ['Малиновое пюре', 'Свежая мята', 'Лимонный сок', 'Сахарный сироп', 'Газированная вода'],
    price: 180,
    category: 'bar',
    subCategory: 'lemonades',
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'raspberry lemonade',
    popular: false,
    new: true,
    rating: 4.9,
    reviews: 25,
